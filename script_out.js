(function() {
    ...
    function initMemoryGame() {
        ...
        const scoreDisplay = container.getElementById('score');
        const timerDisplay = container.getElementById('timer');
        const backText = container.getElementById('back-text');
        const languageSelect = container.getElementById('language-select');
        let score = 0;
        const width = 7;
        const height = 7;
        let cells = [];
