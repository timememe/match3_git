(function() {
    ...
    function initMemoryGame() {
        ...
        let resultLanguage = currentLanguage;
        ...
        if (currentLanguage === 'kk') {
            ...
            resultLanguage = 'az';
        } else if (currentLanguage === 'en_GE') {
            resultLanguage = 'en';
        } else if (currentLanguage === 'ru_KZ') {
            resultLanguage = 'ru';
        } else if (currentLanguage === 'ru_UZ') {
            resultLanguage = 'ru';
        }
        ...
        function endGame() {
            ...
            if (comboCount.card_1 > 0 && comboCount.card_2 > 0 && comboCount.card_3 > 0) {
                showWinPopup();
                awardPoints(1); //
                sendGameResult('game1', 'win', resultLanguage);
            } else {
                showEndPopup();
                sendGameResult('game1', 'loss', resultLanguage);
            }
        }
